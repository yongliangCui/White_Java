package com.tommy.white_jotter.util;
...
public class MyPage<T> implements Iterable<T>, Serializable {
    ...
    //只用把原来的page类放进来即可
    public MyPage(PageInfo<jotter_article> pageInfo) {
        this.content = (List<T>) pageInfo.getList();
        this.totalElements = pageInfo.getTotal();
        this.pageNumber = pageInfo.getPageNum();
        this.pageSize = pageInfo.getSize();
        this.numberOfElements = pageInfo.getPageSize();
    }
